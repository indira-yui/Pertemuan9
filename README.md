...
### Coding By : Indira Aline
### TI.20.A.1
### Pertemuan 9 Praktikum 5
Membuat program sederhana untuk menginput data kedalam list.
 ```python
P = print
while True:
    P("")
...
Terakhir, akan mencetak hasil dari program yang telah dibuat.
![Output](Gambar/Gambar3.jpg)